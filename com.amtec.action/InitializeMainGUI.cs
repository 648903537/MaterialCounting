    ...
    public class InitializeMainGUI
    {
        ...
        public InitModel Initialize()
        {
            ...
            try
            {
                ...
                initModel.scannerHandler.OutputCOM().DataReceived += new SerialDataReceivedEventHandler(view.DataRecivedHeandler2);
            ...
            {
                view.errorHandler(2, view.message(initModel.lang.ERROR_INITIALIZE_ERROR), initModel.lang.ERROR_INITIALIZE_ERROR);
